...
8. **[Project 8 - Hourly Taxi Demand Forecasting Using Time Series](./Project-8-Time-Series-Forecasting/)**  
   Forecast hourly taxi demand using time series features and regression models optimized by RMSE.

9. **[Project 9 - Customer Behavior Prediction with ML](./Project-9-Customer-Behavior-Prediction/)**  
